      ...
      <div className="xl:pl-72 p-5">
        ...
        <div className="mx-auto mt-8 grid grid-cols-1 lg:gap-6 sm:px-6 lg:grid-flow-col-dense lg:grid-cols-4 min-h-screen">
          ...
          <div className="col-span-3">
            <div className="w-full h-full rounded-md bg-white shadow-md border border-gray-200 h-5/6">
              {/* Will be image wrapper at some point for manipulation */}
              {projects.map(project => (
                toggleEKGs
                  .filter(p => p.id === project.id)
                  .some(p => p.selected) && <img src="/_next/static/media/guy.f7047240.jpeg" className='mx-auto py-10 px-10'></img>
              ))}
            </div>
          </div>
        </div>
